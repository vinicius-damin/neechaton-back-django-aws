...
class Comment(models.Model):
    ...
    comment_day = models.CharField(max_length=1000, default = '4')
    comment_month = models.CharField(max_length=1000, default = 'Dec')
    comment_year = models.CharField(max_length=1000, default = '2022')
